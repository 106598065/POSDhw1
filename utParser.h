...
TEST_F(ParserTest, OneMatching) {
  Scanner scanner("X=1.");
  Parser parser(scanner);
  parser.matchings(); //轉換scanner 丟到parser.term裡面
  vector<Term *> terms = parser.getTerms(); //得到Terms
  EXPECT_EQ(2, terms.size());//測試term
...
/*  Number n1(1);
  ...
  EXPECT_EQ("1", terms[0]->value());
  //cout<<"term2->value = "<<terms[2]->value()<<endl;
  EXPECT_EQ("1", terms[2]->value());/**/
  //cout<<"term0->value = "<<terms[0]->value()<<endl;
  //cout<<"term1->value = "<<terms[1]->value()<<endl;
  //cout<<"term2->value = "<<terms[2]->value()<<endl;
  //cout<<"term3->value = "<<terms[3]->value()<<endl;
...
TEST_F(ParserTest, MatchingSuccess) {
  ...
  //cout<<"term 4 = "<<terms[4]->symbol()<<endl;
  //cout<<"term 4 = "<<terms[4]->value()<<endl;
  cout<<"term 5 = "<<terms[5]->symbol()<<endl;
  //cout<<"term 5 = "<<terms[5]->value()<<endl;
}
/**/
#endif
